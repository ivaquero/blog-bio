...
$$
\mathrm{MAPE} = \frac{100}{n} ∑\bigg|\frac{y_i - ŷ_i}{y_i}\bigg|
$$
...
$$
p(ϵ_i) = Φ\bigg(\frac{y_i - μ}{σ} \bigg)
$$
...
\begin{aligned}
  \ln ℒ
  &= \ln \bigg[∏_{i=1}^n \frac{1}{σ\sqrt{2π}} \exp \bigg(-\frac{(y_i - ŷ_i)^2}{2σ^2} \bigg)\bigg] \\
...
$$
\frac{∂\ln ℒ}{∂w} = 2∑ (y_i - wx_i - b)(-x_i) = 2\bigg(w∑ x^2 - ∑ (y - b)x\bigg)
$$
类似地
...
$$
\mathrm{CV}_{(n)} = \frac{1}{n} ∑\bigg(\frac{y_i - ŷ_i}{1 - h_i} \bigg)^2
$$
